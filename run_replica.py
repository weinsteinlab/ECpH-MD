...
print("============================================================================================================")
print('======pH:' + str(pH) + ' subjob_number:' + str(subjob_number) + ' md_steps:' + str(md_steps) 
print("============================================================================================================")
print()
...
print(' pH:', pH, ' subjob:', subjob_number)
full_output_name = './simulations/' +str(output_name) + '-ph' + str(pH) + '-subjob' + str(subjob_number).zfill(4) 
...
if subjob_number == 0:
    ...
    previous_output_name='./simulations/' + str(output_name) + '-ph' + str(pH) + '-subjob' + str(subjob_number - 1).zfill(4)
